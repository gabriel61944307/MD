...
for i in range(2,1000000):
    ...
    if(maior_sequencia>valor_maior_sequencia): #se a sequencia calulada anteriormente for menor que a atual, é substituido o valor da maior sequencia e atribuido o numero a i
